-- =====================================================
-- FIX BOOKINGS VIEW - ADD PAYMENT_STATUS COLUMN
-- =====================================================
-- Purpose: Update bookings_with_details view to include payment_status
-- This fixes the issue where owner sees "Menunggu Pembayaran" even when paid
-- =====================================================

-- Drop and recreate the view to add payment_status column
...
SELECT 
  ...
  b.total_price,
  b.status,
  b.payment_status,  -- ✅ ADDED: Payment status from bookings table
  b.payment_proof_url,
  b.delivery_method,
  b.delivery_fee,
  b.distance_km,
...
-- Verification query
-- Run this to check if payment_status is now included
-- SELECT id, status, payment_status, product_name, renter_name
